...
def read_video_file(file_name, video_number):
    ...
    for i in range(1,frame_count):
        ...
        #static_points, st, err = cv2.calcOpticalFlowPyrLK(gray_old_frame, gray_img, p0, None, **lk_params)

        # use this line when you want to see the movement of specific points
        new_static_points, st, err = cv2.calcOpticalFlowPyrLK(gray_old_frame, gray_img, static_points, None, **lk_params)
